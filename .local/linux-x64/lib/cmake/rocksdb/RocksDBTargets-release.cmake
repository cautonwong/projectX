...
set_target_properties(RocksDB::rocksdb-shared PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "gflags::gflags_shared;Snappy::snappy"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/librocksdb.so.10.6.0"
  IMPORTED_SONAME_RELEASE "librocksdb.so.10"
  )

list(APPEND _cmake_import_check_targets RocksDB::rocksdb-shared )
list(APPEND _cmake_import_check_files_for_RocksDB::rocksdb-shared "${_IMPORT_PREFIX}/lib/librocksdb.so.10.6.0" )
